...
엔드포인트 슬라이스는 [엔드포인트 슬라이스](/docs/concepts/services-networking/endpoint-slices/)에서
...
프록시된다. kube-proqxy는 사용할 백엔드 파드를 결정할 때 서비스의
...
파드 [준비상태 프로브](/docs/concepts/workloads/pods/pod-lifecycle/#container-probes)를 사용하여
